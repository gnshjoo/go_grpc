...
protos:
	protoc -I/usr/local/include -I. -I$(GOPATH)/src -I$(GOPATH)/pkg/mod/github.com/grpc-ecosystem/grpc-gateway/v2@v2.0.1/third_party/googleapis --go-grpc_out=:. --go_out=:. config/config.proto
